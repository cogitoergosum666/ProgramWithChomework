...
int showMainMenu() {
	...
	printf("7.调用实验4生成数据记录文件、读取数据记录文件并排序（文本方式输出，二维数组方式存储）\n");
	printf("8.调用实验4生成数据记录文件、读取数据记录文件并排序（文本方式输出，结构体数组方式存储）\n");
	printf("9.调用实验4生成数据记录文件、读取数据记录文件并排序（文本方式输出，指针数组方式存储）\n");
	printf("10.调用实验4生成数据记录文件、读取数据记录文件并排序（文本方式输出，链表方式存储）\n");
	printf("11.调用实验4生成数据记录文件、读取数据记录文件并排序（二进制方式输出，二维数组方式存储）\n");
	printf("12.调用实验4生成数据记录文件、读取数据记录文件并排序（二进制方式输出，结构体数组方式存储）\n");
	printf("13.调用实验4生成数据记录文件、读取数据记录文件并排序（二进制方式输出，指针数组方式存储）\n");
	printf("14.调用实验4生成数据记录文件、读取数据记录文件并排序（二进制方式输出，链表方式存储）\n");
